    ...
    <div class="content1">
      <div class="registerPage">
        <div v-if="step === 1" class="tdbModule register">
          <div class="registerTitle2">注册账户</div>
          ...
          <div class="registerCont2">
            <ul>
              ...
              <li>
                ...
                <input class="input" v-model="user.code" placeholder="短信验证码" />
                <!-- <span class="info">
                  请输入验证码
                </span> -->
              </li>
              ...
              <li>
                ...
                <input type="password" v-model="user.password" class="input" placeholder="密码 6~24个字符 英文数字组成" />
                <!-- <span class="info">
...
export default {
  ...
  methods: {
    ...
    send() {
      ...
      this.$axios.$get('/api/sms/send/' + this.user.mobile).then((response) => {
    ...
    //注册
    register() {
      this.$axios.$post('/api/core/user/register', this.user).then((response) => {
        this.step = 2
      })
    },
  },
