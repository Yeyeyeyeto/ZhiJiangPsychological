package com.eternal.common.result;
...
public enum ResponseEnum {
    ...
    //-2xx 参数校验
    QUESTION_AMOUNT_NULL_ERROR(-201, "问卷名不能为空"),
    ...
    RENCENT_RESPONSE_ERROR(-501, "短信服务响应失败"),
    RENCENT_SMS_LIMIT_CONTROL_ERROR(-502, "短信发送过于频繁"),//业务限流
    RENCENT_SMS_ERROR(-503, "短信发送失败"),//其他失败
